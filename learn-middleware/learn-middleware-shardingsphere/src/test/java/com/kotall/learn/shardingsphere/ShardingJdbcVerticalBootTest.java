...
@SpringBootTest
public class ShardingJdbcVerticalBootTest {
...
//            user.setUserId(1L);
    ...
    public void test_getUser() {
        User user = userMapper.selectById(1488483820427653123L);
    ...
    public void test_deleteUser() {
        Wrapper<User> wrapper = new LambdaQueryWrapper<User>().eq(User::getUserId, 1488483820427653123L);
